...
<head>
    ...
    <script>
        function procurar() {
            ...
            switch (searchTerm) {
                case 'hamburguer':
                    window.location.href = 'http://127.0.0.1:800/burger';
                    break;
                case 'pizza':
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menus">
            <a href="crieaconta"><ion-icon name="storefront-outline"></ion-icon>Home</a>
            <a href="crieaconta"><ion-icon name="receipt-outline"></ion-icon>Meus Pedidos</a>
            <!--<a href="#"><ion-icon name="wallet-outline"></ion-icon>Pagamentos</a>-->
            <a href="crieaconta"><ion-icon name="notifications-outline"></ion-icon>Notificações</a>
            <a href="crieaconta"><ion-icon name="chatbubbles-outline"></ion-icon>Contato</a>
            <!--<a href="#"><ion-icon name="settings-outline"></ion-icon>Configurações</a>-->
        </div>


        <div class="sidebar-logout">
            <a href="crieaconta"><ion-icon name="log-out-outline"></ion-icon>Sair</a>
        </div>
    </div>
    ...
    <div class="main">
        ...
        <div class="main-navbar">
            ...
            <div class="profile">
                <a class="cart" href="crieaconta"><ion-icon name="cart-outline"></ion-icon> </a>
                <a class="user" href="crieaconta"><ion-icon name="person-outline"></ion-icon>  </a>
            </div>
        </div>
