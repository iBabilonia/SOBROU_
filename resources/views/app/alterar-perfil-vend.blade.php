...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menus">
            ...
            <a href="adicionarproduto"><ion-icon name="add-circle-outline"></ion-icon>Adicionar Produto</a>
        </div>
    ...
    <div class="main">
        <div class="profile-container">
            ...
            <br><br>
            <a href="recuperarsenhavend" class="btn">Esqueci/Alterar Senha</a>
            <br><br>
            <a href="usuariovend" class="btn">Voltar Para o Perfil</a>
