    ...
    <div class="main">
        ...
        <div class="main-menus">
            ...
            <div class="main-detail">
                <h2 class="main-title">Escolhas Pizza Próximas de Você</h2>
                <div class="detail-wrapper">
                    <div class="detail-card">
                        
                        <div class="detail-desc">
                            <div class="detail-name">
                                <img class="detail-img" src="./img/peperoni.JFIF">
                                <h4>Pepperoni</h4>
                                <p class="detail-sub">Queijo, pimenta do reino e calabresa apimentada.</p>
                                <p class="price">R$32,00</p>
                            </div>
                            <ion-icon class="detail-favorites" name="bookmark-outline"></ion-icon>
                        </div>
                        <div class="detail-card">
                            <img class="detail-img" src="./img/rucula.JFIF">
                            <div class="detail-desc">
                                <div class="detail-name">
                                    <h4>X-BURGER</h4>
                                    <p class="detail-sub">ovo, pedaços de rucula, tomate seco, queijo e azeitona.</p>
                        ...
                        <div class="detail-card">
                            <img class="detail-img" src="./img/marguerita.JFIF">
                            <div class="detail-desc">
                                <div class="detail-name">
                                    <h4>Margherita</h4>
                                    <p class="detail-sub">Queijo, tomate, azeitona e orégano.</p>
                        ...
                        <div class="detail-card">
                            <img class="detail-img" src="./img/3por55.JFIF">
                            <div class="detail-desc">
                                <div class="detail-name">
                                    <h4>3 por 55</h4>
                                    <p class="detail-sub">Escolha 3 entre os sabores mussarela, calabrasa, rúcula e bacon.</p>
                        ...
                        <div class="detail-card">
                            ...
                            <div class="detail-desc">
                                <div class="detail-name">
                                    <h4>Calabresa</h4>
                                    <p class="detail-sub">Queijo, calabresa e cebola.</p>
                                    <p class="price">R$32,00</p>
                                </div>
                                <ion-icon class="detail-favorites" name="bookmark-outline"></ion-icon>
                            </div>
